/**
 * This is mostly copied from https://code.visualstudio.com/docs/editor/tasks-appendix with the following changes
 *
 * - Add `export` to each definition
 * - Make `type` and `command` optional
...
export interface BaseTaskConfiguration {
   ...
   */
  problemMatcher?: string | ProblemMatcher | readonly (string | ProblemMatcher)[]

  /**
   * The configuration of the available tasks. A tasks.json file can either
   * contain a global problemMatcher property or a tasks property but not both.
   */
  tasks?: readonly TaskDescription[]
}
...
export interface PresentationOptions {
  /**
   * Controls whether the task output is reveal in the user export interface.
   * Defaults to `always`.
   */
   ...
   * in the user export interface. Defaults to `true`.
   */
  echo?: boolean
...
export interface ProblemMatcher {
   ...
   */
  fileLocation?: string | readonly string[]
   ...
   */
  pattern?: string | ProblemPattern | readonly ProblemPattern[]
